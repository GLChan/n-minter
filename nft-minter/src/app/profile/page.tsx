...
export default function ProfilePage() {
  ...
  const [userData, setUserData] = useState<User>(mockUser); // 真实应用中应初始化为空对象并通过API获取
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-zinc-400 dark:text-zinc-500">{userData.joinedDate}</p>
              {userData.external_link && (
                <a 
                  href={userData.external_link} 
                  target="_blank" 
