...
export enum ActionType {
  MINT_NFT = "MINT_NFT", // 铸造 NFT
  LIST_NFT = "LIST_NFT", // 上架 NFT
  UNLIST_NFT = "UNLIST_NFT", // 下架 NFT
  SELL_NFT = "SELL_NFT", // (你作为卖家)
  BUY_NFT = "BUY_NFT", //  (你作为买家)
  TRANSFER_NFT = "TRANSFER_NFT", // 转移 NFT

  UPDATE_SETTINGS = "UPDATE_SETTINGS", // 更新用户设置
  UPDATE_PROFILE = "UPDATE_PROFILE", // 更新用户资料
  FOLLOW_USER = "FOLLOW_USER", // 关注用户
  UNFOLLOW_USER = "UNFOLLOW_USER", // 取消关注用户

  FAVORITE_COLLECTION = "FAVORITE_COLLECTION", // 收藏合集
  CREATE_COLLECTION = "CREATE_COLLECTION", // 创建合集
  UPDATE_COLLECTION = "UPDATE_COLLECTION", // 更新合集
  DELETE_COLLECTION = "DELETE_COLLECTION", // 删除合集

  UPDATE_NFT = "UPDATE_NFT", // 更新 NFT 信息
  DELETE_NFT = "DELETE_NFT", // 删除 NFT
  CREATE_OFFER = "CREATE_OFFER", // 创建 NFT 出价
  ACCEPT_OFFER = "ACCEPT_OFFER", // 接受 NFT 出价
  REJECT_OFFER = "REJECT_OFFER", // 拒绝 NFT 出价
  CANCEL_OFFER = "CANCEL_OFFER", // 取消 NFT 出价
  CREATE_AUCTION = "CREATE_AUCTION", // 创建 NFT 拍卖
  PLACE_BID = "PLACE_BID", // 出价
  CANCEL_BID = "CANCEL_BID", // 取消出价
  END_AUCTION = "END_AUCTION", // 结束拍卖
  REPORT_NFT = "REPORT_NFT", // 举报 NFT
  REPORT_USER = "REPORT_USER", // 举报用户
  REPORT_COLLECTION = "REPORT_COLLECTION", // 举报合集
