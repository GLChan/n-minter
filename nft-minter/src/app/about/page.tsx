...
const features = [
  {
    ...
    title: "创建NFT",
    description:
      "简单几步即可将您的艺术作品、音乐或收藏品转化为NFT，无需编程知识。",
  },
  {
    icon: (
      <svg
    ...
    title: "低费用",
    description:
      "我们采用Layer 2解决方案，大幅降低Gas费用，让创作者和收藏家都能负担得起。",
  },
  {
    icon: (
      <svg
    ...
    title: "多链支持",
    description:
      "支持以太坊、Polygon、Solana等多个区块链，为用户提供更多选择和灵活性。",
  },
  {
    icon: (
      <svg
...
const teamMembers = [
  {
    ...
    avatar:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=faces&q=80",
  },
  {
    name: "林小雨",
    role: "产品设计总监",
  ...
  },
  {
    ...
    avatar:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=faces&q=80",
  },
];
...
const faqs = [
  {
    question: "什么是NFT？",
    answer:
      "NFT（非同质化代币）是一种基于区块链技术的数字资产，每个NFT都是唯一的，不可替代的。它们可以代表数字艺术、音乐、视频、游戏内物品等，通过区块链技术确保所有权和真实性。",
  },
  {
    question: "如何创建我的第一个NFT？",
    answer:
      '创建NFT非常简单：1) 注册并连接您的钱包；2) 点击"创建"按钮；3) 上传您的数字作品；4) 填写详细信息如标题、描述和定价；5) 支付一次性铸造费用；6) 确认交易后，您的NFT就创建成功了！',
  },
  {
    question: "在平台上交易NFT需要支付哪些费用？",
    answer:
      "我们的平台收取较低的交易费用，通常为销售价格的2.5%。此外，根据您选择的区块链，您可能需要支付网络的Gas费用。我们采用Layer 2解决方案，大大降低了这部分成本。",
  },
  {
    question: "我可以用什么加密货币在平台上交易？",
    answer:
      "我们支持多种加密货币，包括ETH、USDC、MATIC等。具体支持的货币类型取决于您选择使用的区块链网络。",
  },
  {
    question: "如何保护我的NFT资产安全？",
    answer:
      "保护您的NFT安全的最佳方式是妥善保管您的钱包私钥和助记词，使用硬件钱包存储高价值资产，启用双因素认证，并警惕各类钓鱼网站和欺诈行为。",
  },
];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white dark:bg-zinc-800 p-6 rounded-xl border border-zinc-100 dark:border-zinc-700"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member) => (
              <div
                key={member.name}
                className="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-100 dark:border-zinc-700 overflow-hidden"
              >
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-6 mb-8">
            <button className=" text-zinc-600 dark:text-zinc-400 hover:text-blue-500 dark:hover:text-blue-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
